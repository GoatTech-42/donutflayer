...
class BotManager {
  ...
  removeServer(id) { this.servers.delete(id); }

  getBots() { return Array.from(this.bots.values()); }
  ...
  async createBot(data) {
    ...
    const bot = new MineflayerBot(id, {
  ...
  removeBot(id) {
    ...
    if (bot) { bot.disconnect(); this.bots.delete(id); }
  }
